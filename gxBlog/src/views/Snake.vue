      ...
      <div ref="gameCanvas" class="game-canvas"
        ...
        <div v-if="gameController.food" class="food" :class="{
          ...
          <div class="food-inner">
            <!-- 增加长度食物图标 -->
            <svg v-if="gameController.food.type === 'grow'" class="food-icon" viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg">
              <!-- 水果图标 - 根据degree值显示不同水果 -->
              <!-- 香蕉 (degree 0-2) -->
              <g v-if="gameController.food.degree >= 0 && gameController.food.degree <= 2">
                <path
              ...
              <!-- 番茄 (degree 3-5) -->
              <g v-else-if="gameController.food.degree >= 3 && gameController.food.degree <= 5">
              ...
              <!-- 桃子 (degree 6-8) -->
              <g v-else-if="gameController.food.degree >= 6 && gameController.food.degree <= 8">
                <path
            ...
            <!-- 减少长度食物图标 -->
            <svg v-else-if="gameController.food.type === 'shrink'" class="food-icon" viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg">
              <!-- 书本 (degree -1 到 -3) -->
              <g v-if="gameController.food.degree >= -3 && gameController.food.degree <= -1">
                <path
              ...
              <!-- 电脑 (degree -4 到 -6) -->
              <g v-else-if="gameController.food.degree >= -6 && gameController.food.degree <= -4">
                <path
                  d="M4,6H20V16H4M20,18A2,2 0 0,0 22,16V6C22,4.89 21.1,4 20,4H4C2.89,4 2,4.89 2,6V16A2,2 0 0,0 4,18H0V20H24V18H20Z"
                  fill="#607D8B" />
              </g>
              <!-- 粑粑 (degree -7 到 -8) -->
              <g v-else-if="gameController.food.degree >= -8 && gameController.food.degree <= -7">
                <path
            ...
            <!-- 加速度食物图标 -->
            <svg v-else-if="gameController.food.type === 'fast'" class="food-icon" viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg">
              <!-- 飞机 (degree 21-24) -->
              <g v-if="gameController.food.degree >= 21 && gameController.food.degree <= 24">
                <path
              ...
              <!-- 火车 (degree 25-27) -->
              <g v-else-if="gameController.food.degree >= 25 && gameController.food.degree <= 27">
                <path
            ...
            <!-- 减速度食物图标 -->
            <svg v-else-if="gameController.food.type === 'slow'" class="food-icon" viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg">
              <!-- 泥巴 (degree 11-15) -->
              <g v-if="gameController.food.degree >= 11 && gameController.food.degree <= 15">
                <path
